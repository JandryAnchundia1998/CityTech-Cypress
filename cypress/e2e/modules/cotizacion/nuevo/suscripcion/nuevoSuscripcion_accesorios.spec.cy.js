describe("VH-Nuevo-Suscripcion-Accesorios", () => {
    beforeEach(() => {
        cy.clearSession();
    ...
    it("VH-Nuevo-Suscripcion-Accesorios", () => {
        cy.fixture("cotizacion/nuevo/suscripcion/nuevoSuscripcion_accesorios.json").then((datos) => {
