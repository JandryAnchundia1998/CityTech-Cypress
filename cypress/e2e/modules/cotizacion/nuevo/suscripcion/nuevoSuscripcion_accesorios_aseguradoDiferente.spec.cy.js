describe("VH-Nuevo-Suscripcion-Accesorios-AseguradoDiferente", () => {
    beforeEach(() => {
        cy.clearSession();
    ...
    it("VH-Nuevo-Suscripcion-Accesorios-AseguradoDiferente", () => {
        cy.fixture("cotizacion/nuevo/suscripcion/nuevoSuscripcion_accesorios_aseguradoDiferente.json").then((datos) => {
          ...
          if (
            ...
            cy.contains('Valor comercial').parent().find('input').should('exist').clear();
            cy.get(
          ...
          if (dato.contratante.caso_1.caso === "Completar campos obligatorios") {
            ...
            //cy.get('.ng-submitted > .ng-invalid.ng-touched')
            //cy.get('div.ng-untouched')
            cy.genero('div.ng-untouched', dato.persona.genero);
          ...
          if (
            ...
            cy.get(".ng-option-label").click();*/
            //cy.get('[formgroupname="InsuredPersonData"]')
            cy.genero('[formgroupname="InsuredPersonData"]', dato.personaAsegurar.genero);
