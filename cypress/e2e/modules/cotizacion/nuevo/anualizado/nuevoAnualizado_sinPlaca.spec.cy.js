describe("VH-Nuevo-Anualizado-sinPlaca", () => {
    beforeEach(() => {
    ...
    it.only("VH-Nuevo-Anualizado-sinPlaca", () => {
        cy.fixture("cotizacion/nuevo/anualizado/nuevoAnualizado_sinPlaca.json").then((datos) => {
            ...
            cy.contains('Marca').parent().then(($text)=>{
                //text == '' ? Marca = true : Marca = false;q
                if(!$text.val()){
            ...
            cy.contains('Modelo').parent().then(($text)=>{
              //text == '' ? Marca = true : Marca = false;q
              if(!$text.val()){
            ...
            cy.contains('Año').parent().then(($text)=>{
            //text == '' ? Marca = true : Marca = false;q
              if(!$text.val()){
